...
rowWrapper: { display: 'flex', alignItems: 'center', width: '100%' },
...
editGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', background: '#fff', padding: '8px', borderRadius: '10px', border: '1px solid #000', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', width: '100%' },
editOptionBtn: { border: '1px solid #e5e5ea', background: '#fff', color: '#000', fontSize: '12px', padding: '12px 0', cursor: 'pointer', fontWeight: 600, borderRadius: '8px', transition: 'all 0.1s' },
editOptionBtnActive: { background: '#000', color: '#fff', border: '1px solid #000' },
...
// [FIX] Add Unit Button: alignSelf: "center" 추가 (HUD 중앙 정렬)
addUnitBlockBtn: {
width: "340px",
padding: "16px",
background: "#fff",
...
transition: "all 0.2s ease",
pointerEvents: "auto",
alignSelf: "center" // [핵심 수정] 부모(HUD Wrapper)가 items-end라도 중앙 정렬
},
...
// [FIX] Cart Button: sideButton과 동일한 스타일 적용 (대칭성)
cartButton: {
pointerEvents: "auto",
width: "64px",
height: "64px",
borderRadius: "20px",
background: "#F2F2F5", // 검정 -> 밝은 회색
color: "#000", // 흰색 -> 검정
border: "1px solid rgba(0,0,0,0.05)",
display: "flex",
alignItems: "center",
