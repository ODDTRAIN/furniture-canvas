...
export const BirchEdgeMaterialHorizontal = (props) => { const t = useConfiguredTexture({ map: "/textures/birch_edge.jpg", normalMap: "/textures/birch_edge_NORMAL.jpg" }, 0.3, 1, false); return <meshStandardMaterial {...props} {...t} color="#ffffff" roughness={0.6} metalness={0.0} />; };
export const BirchEdgeMaterialVertical = (props) => { const t = useConfiguredTexture({ map: "/textures/birch_edge.jpg", normalMap: "/textures/birch_edge_NORMAL.jpg" }, 0.3, 1, true); return <meshStandardMaterial {...props} {...t} color="#ffffff" roughness={0.6} metalness={0.0} />; };
export const ChromeMaterial = (props) => { const t = useConfiguredTexture({ normalMap: "/textures/Poliigon_MetalSteelBrushed_7174_Normal.png", roughnessMap: "/textures/Poliigon_MetalSteelBrushed_7174_Roughness.jpg" }, 1.3, 2, true); return <meshStandardMaterial {...props} {...t} color="#ffffff" roughness={0.7} metalness={0.9} envMapIntensity={1} />; };
